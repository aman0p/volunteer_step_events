...
export const notifyAdminsOnEnrollmentApplication = async (params: {
   eventId: string;
   enrollmentId: string;
...
export const notifyUserOnEnrollmentStatusChange = async (params: {
   userId: string;
   eventId: string;
   enrollmentId: string;
   status: Status;
...
export const notifyEnrolledVolunteersOnEventUpdate = async (
   eventId: string
) => {
   try {
...
export const notifyEnrolledVolunteersOnEventDeletion = async (
   eventId: string,
   eventTitle: string
) => {
   try {
