...
export default function NotFound() {
   return (
      <div className="flex h-screen w-full items-center justify-center p-15">
         <div className="mx-auto h-full w-full space-y-2 rounded-xl md:w-4xl md:space-y-5 md:rounded-2xl md:px-2 lg:w-6xl lg:rounded-3xl lg:px-0">
