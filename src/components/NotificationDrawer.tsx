                              ...
                              {selectedIds.size > 0 && (
                                 <>
                                    <button
                                       ...
                                       disabled={isPending}
                                       className="hidden rounded-md bg-gray-100 px-2 py-1 text-xs hover:bg-gray-200 disabled:opacity-50 sm:inline"
                                    >
                                       Mark as read
                                    </button>
                                    <button
                                       ...
                                       disabled={isPending}
                                       className="bg-destructive/10 text-destructive hover:bg-destructive/20 rounded-md px-2 py-1 text-xs disabled:opacity-50"
                                    >
                                       Delete
                                    </button>
                                 </>
