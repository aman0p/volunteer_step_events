...
import { updateCurrentUserProfile } from "@/lib/user/profile";
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col gap-1 w-full">
                      ...
                      <FormControl>
                        <Bordered className="w-full">
                          <Input placeholder="Gender (e.g., MALE/FEMALE/OTHER)" {...field} className="w-full px-3 py-2 text-sm rounded-md transition-all duration-200 border-0" />
                        </Bordered>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col gap-1">
                    ...
                    <div>
                      <FormControl>
                        <Bordered className="max-w-[450px] min-w-[310px] w-full rounded-md border-gray-400 border-dashed">
                          <FileUpload
                            type="image"
                            accept="image/*"
                            ...
                            value={field.value}
                            className="w-full aspect-square object-cover border-0 rounded-md"
                          />
                        </Bordered>
                      </FormControl>
                    </div>
