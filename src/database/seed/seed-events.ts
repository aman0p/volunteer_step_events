...
export async function seedEvents() {
   ...
   try {
      ...
      if (creators.length === 0) {
         console.log(
            '👤 No users found. Creating a default event creator user...'
         );
         ...
         const defaultUser = await prisma.user.create({
            data: {
               ...
               profileImage:
                  'https://ik.imagekit.io/praveenlodhiofficial/users/profile/profile_nQkcdEiM1.webp?updatedAt=1756423316001',
               govIdImage:
                  'https://ik.imagekit.io/praveenlodhiofficial/users/gov-id/govt-id_hTp9DNNv8.webp?updatedAt=1756423306534',
               role: 'USER',
               isVerified: false,
            },
         });
